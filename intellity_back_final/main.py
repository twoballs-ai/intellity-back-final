...
app.include_router(study_course_checker_views, prefix="/api/v1/study", tags=["основной функционал lms проверки курсов на прохождение"], dependencies=[Depends(oauth2_scheme)])
